export default function AsidePost() {
  return (
    <aside className="flex w-24 mt-4">
        ...
        <button>
          <span>
            <svg
              ...
              role="img"
              aria-hidden="true"
              className="mb-2 hover:fill-red-600"
            >
        ...
        <button>
          <span>
            <svg
              ...
              role="img"
              aria-hidden="true"
              className="crayons-icon mb-2 hover:fill-amber-400"
            >
        ...
        <button>
          <span>
            <svg
              ...
              role="img"
              aria-hidden="true"
              className="crayons-icon mb-2 hover:fill-blue-600"
            >
        ...
        <div className="rounded-full p-2 hover:bg-gray-200">
          <span>
            <svg
              ...
              height="24"
              role="img"
              aria-labelledby="a8mb6gpbnbnck1fdem01an58vtwldhsn"
              aria-hidden="true"
              className="crayons-icon dropdown-icon fill-gray-500"
            >
              <title id="a8mb6gpbnbnck1fdem01an58vtwldhsn">More...</title>
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
